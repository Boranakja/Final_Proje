...
#initilaizer(yapıcı) modu tanımlıdır. Hasta sınıfının ilgili özellikleri tanımlanır.
    ...
    def tedavi_suresi_hesapla(self):
        # Basit bir örnek olarak, tedavi süresini rastgele bir değer döndürelim
        import random
        return random.randint(1, 100)
#get ve set metodlarıyla hasta ile ilgili özellikler tanımlanır
    def __str__(self):
